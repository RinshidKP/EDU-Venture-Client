        ...
        <div className="container">
          <div className="bg-white bg-opacity-70 w-full shadow-xl rounded-lg">
            <div className="text-center flex justify-center flex-col">
              <div className='flex justify-center items-center w-full sm:w-3/4 mb-5 py-5 px-5 mx-auto bg-gray-200 shadow-lg flex-col sm:flex-row'>
                ...
                <div className='m-5 flex flex-col'>
                  ...
                  <div className="user-info flex-1">
                    <p className="mb-0 text-red-500">
                      {imgUrl ? null : 'Please Update Your Profile Details!!'}
                    </p>
                    <button
