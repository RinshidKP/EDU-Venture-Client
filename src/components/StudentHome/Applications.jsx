    ...
    <div className='w-full flex justify-center  items-center animate-flip-down'>
      <div className='w-5/6 bg-white py-10 shadow-lg flex flex-wrap justify-around'>
        {applications.map((application, index) => (
          <div
          key={index}
          className='relative group/item group-hover bg-white w-1/4 m-2 p-6 transition-transform transform hover:scale-110 hover:translate-x-2 hover:translate-y-2 rounded-lg shadow-md flex flex-col justify-center items-center group-hover:shadow-lg'
        >
        ...
        <h1 className="uppercase font-semibold tracking-wide text-lg">
          ...
          <button className="absolute group/edit rounded-b bottom-0 bg-sky-900 text-white py-2 px-4 invisible group-hover/item:visible">
