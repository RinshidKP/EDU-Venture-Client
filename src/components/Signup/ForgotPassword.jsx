    ...
    <div className="bg-green-100 h-screen flex flex-col items-center justify-center">
      {!otpSend && <div className="custom-checkbox-container flex items-center justify-center mb-4 sm:mb-8">
        ...
        >
          ...
          />
          <span
            className={`px-4 py-2 rounded-l-md cursor-pointer ${isChecked ? "bg-emerald-200" : "bg-gray-300"
              }`}
          >
            <FontAwesomeIcon icon={faUser} /> User
          </span>
          <span
            className={`px-4 py-2 rounded-r-md cursor-pointer ${isChecked ? "bg-gray-300" : "bg-emerald-200"
              }`}
          >
